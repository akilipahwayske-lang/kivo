...
const PartnerBadge = ({ name, type }: { name: string; type: string }) => (
    <div className="relative group cursor-default">
        {/* Badge Background */}
        <div className="relative py-4 px-8 bg-white/5 border border-white/10 group-hover:border-primary/40 transition-all duration-500 overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center">
                <span className="text-xl md:text-2xl font-display font-black text-white/50 group-hover:text-white transition-colors tracking-tighter uppercase">
                    {name}
                </span>
                <span className="text-[6px] font-black uppercase tracking-[0.4em] text-white/20 group-hover:text-primary transition-colors mt-1">
                    {type}
                </span>
            </div>

            {/* Corner Markers */}
            <div className="absolute top-0 left-0 w-1 h-1 border-t border-l border-white/20 group-hover:border-primary" />
            <div className="absolute bottom-0 right-0 w-1 h-1 border-b border-r border-white/20 group-hover:border-primary" />
        </div>
    </div>
);
            ...
            <div className="container mx-auto px-4">
                <div className="grid lg:grid-cols-4 gap-16 items-center">
                    <div className="lg:col-span-1">
                        ...
                        <h3 className="text-xl font-black text-white/40 uppercase leading-tight tracking-tighter">
