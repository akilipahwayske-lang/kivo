            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="mt-20 flex justify-center">
                    <button
                        ...
                        className="px-12 py-6 border border-white/10 text-white font-black text-xs uppercase tracking-widest hover:bg-white/5 transition-all group"
                    >
                ...
                {showArchive && (
                    ...
                    >
                        <motion.div
                            ...
                            className="w-full max-w-6xl bg-[#0a0a0a] border border-white/10 rounded-2xl overflow-hidden shadow-2xl flex flex-col max-h-[90vh]"
                        >
                            {/* Modal Header */}
                            <div className="p-8 border-b border-white/10 flex items-center justify-between bg-black/50">
                                <div className="flex items-center gap-6">
                                    ...
                                    <div>
                                        <h2 className="text-2xl font-black text-white uppercase tracking-tighter">Deep Dive Archive</h2>
                                        <p className="text-[10px] uppercase font-black tracking-widest text-white/30">Select Technical Deployments // KIVO AI</p>
                                    </div>
                                </div>
                                <button
                                    onClick={() => setShowArchive(false)}
                                    className="p-3 hover:bg-white/10 rounded-full text-white/40 hover:text-white transition-all underline decoration-primary underline-offset-8 decoration-2"
                                >
                                    <X size={24} />
                                </button>
                            </div>
                            ...
                            <div className="flex-grow overflow-y-auto p-8 md:p-12 custom-scrollbar">
                                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {archivedProjects.map((project, i) => (
                                        <div key={i} className="group relative aspect-square bg-[#050505] border border-white/5 overflow-hidden">
                                            <img
                                                src={project.image}
                                                alt={project.title}
                                            ...
                                            <div className="absolute inset-0 p-8 flex flex-col justify-end">
                                                ...
                                                <h4 className="text-xl font-black text-white uppercase mb-2 tracking-tighter">
                                                    {project.title}
                                                </h4>
                                ...
                                <div className="mt-20 p-12 bg-primary/5 border border-primary/20 rounded-2xl text-center">
                                    ...
                                    <h3 className="text-3xl font-black text-white uppercase mb-4 tracking-tighter">Request Full Engineering Portfolio</h3>
